...
RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "argc: %d", argc);
  if (argc != 4) {
    ...
    RCLCPP_INFO(rclcpp::get_logger("rclcpp"),
                "passerd arg 1: %lld, arg 2: %lld, arg 3: %lld", atoll(argv[1]), atoll(argv[2]), atoll(argv[3]));
  ...
  rclcpp::Client<tutorial_interfaces::srv::AddThreeInts>::SharedPtr client =
      ...
      RCLCPP_INFO(rclcpp::get_logger("rclcpp"),
                "client created for service: add_three_ints");
  auto request =
      std::make_shared<tutorial_interfaces::srv::AddThreeInts::Request>();
